...
print("Ottimizzatore: ITERATED_LOCAL_SEARCH")
...
for i in range(1,MAX_RESTART+1):
    ...
    results = local_search(G, start_solution=mst, ROOT_NODE=ROOT_NODE, 
    ...
    #
    # non posso usare 2-opt perchè il grafo non è completo!
...
filename = "ITERATED-LS_{}_{}__cost_{}_{}.json".format(V, E, results["cost"], timestamp)
with open("trials/"+filename, "w+") as f:
    data = save_graph(mst)
    json.dump(data,f)
 """
